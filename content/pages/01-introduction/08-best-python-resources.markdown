...
* [Hyperskill](https://hi.hyperskill.org/) takes you through Python by 
  building 5 different projects with increasing difficulty. You'll get to know 
  the basic syntax of Python, some standard libraries and the Django framework 
