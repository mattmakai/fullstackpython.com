...
a [Flask](/flask.html) application.

[SQLAlchemy](https://www.sqlalchemy.org/) is used to read, write, query 
and delete persistent data in a [relational database](/databases.html) 
through SQL or the 
[object-relational mapper (ORM)](/object-relational-mappers-orms.html) 
interface built into the project. 


## Example 1 from flasky
...
[his books and videos](https://courses.miguelgrinberg.com/). All of
his content is highly recommended and well worth the purchase price.
I frequently read his materials to brush up on my Flask skills.
